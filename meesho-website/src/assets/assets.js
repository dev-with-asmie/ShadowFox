...
import lowest_price from './reduce-cost.png'
import app_qr from './app-qr.png'
import shoes_1 from '../assets/shoes1.jpg'
import shoes_2 from '../assets/shoes2.webp'
import electronics_1 from '../assets/electronics1.avif' 
...
export const products = [
    ...
    image: [shoes_1],
    price: 750,
  description: "Comfortable and trendy Men's Shoes for daily use.",
  category: "footwear",
  subCategory: "shoes",
  sizes: ["S", "M", "L"] 
},
{
  ...
  image: [shoes_2],
  price: 900,
  description: "Comfortable and trendy Women Heels for daily use.",
  category: "footwear",
  subCategory: "shoes",
  sizes: ["S", "M", "L"] 
},
{
  ...
  image: [electronics_1], 
  price: 350,
  description: "ONBIZ Wireless Neckband with 20+ HRS Playtime, Bluetooth V5.0, ENx™ Clear Voice Calls and 10MM Clarity Drivers",
